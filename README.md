...
[Mohamed](https://github.com/z4cope/math-magicians/pull/1))
...
```
https://github.com/z4cope/math-magicians.git
...
```
$ git clone {https://github.com/z4cope/math-magicians.git}
```
...
- [x] Basic knowledge of **React** Javascript ui framework.
...
Clone this repository to your desired folder:
    ...
    _git clone https://github.com/z4cope/math-magicians.git_
...
Feel free to check the [issues page](https://github.com/z4cope/math-magicians/issues).
